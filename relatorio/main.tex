...
\IEEEauthorrefmark{2}teodecampos@unb.br}}
...
\begin{figure}
\centering
\subfloat[Learning Rate Optimization\label{lrfind}]{\includegraphics[width=.5\columnwidth]{LR_find.png}}
\subfloat[cyclical learning rate policy\label{sconv}]{\includegraphics[width=.5\columnwidth]{lr_cycle.png}}\hfil
